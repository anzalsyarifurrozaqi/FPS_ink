...
namespace Ink_Project
{
    public class PaintManager2 : Singleton<PaintManager2>
    {
        ...
        public void initTextures(Paintable2 paintable)
        {
        ...
        public void paint (Paintable2 paintable, Vector3 pos, float radius = 1f, float hardness = .5f, float strength = .5f, Color? color = null)
        {
            RenderTexture mask = paintable.getMask();
            RenderTexture uvIslands = paintable.getUVIslands();
            RenderTexture extend = paintable.getExtend();
